            ...
            <div>
                ...
                <form action="actions/updateresume.action.php" method="post" class="row g-3 p-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1111111111" name="mobile_no" placeholder="9569569569" max="9999999999" value="<?=@$resume['mobile_no']?>"
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="address" value="<?=$resume['address']?>" id="inputAddress" placeholder="1234 Main St" required>
                    </div>
                    <hr>
 ...
 foreach($exps as $exp){
    ...
    <div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                    if you can have experience, you can add it
                                </p>
...
<div class="modal fade" id="addexp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" name="company" class="form-control" placeholder="Dominos,New Delhi" id="inputPassword4" required>
  </div>
  <div class="col-md-6">
...
<div class="modal fade" id="addedu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" name="institute" class="form-control" placeholder=" Central Board Of Secondary Education, New Delh" id="inputPassword4" required>
  </div>
  <div class="col-md-6">
